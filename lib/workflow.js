...
export function pullWorkflow(workflowId, env) {
  ...
  try {
    const { activeVersion: _av, shared: _sh, versionId: _vi, activeVersionId: _avi, versionCounter: _vc, triggerCount: _tc, pinData, id: _id, createdAt: _ca, updatedAt: _ua, isArchived: _ia, staticData: _sd, meta: _me, ...workflow } = JSON.parse(result.stdout.toString());
